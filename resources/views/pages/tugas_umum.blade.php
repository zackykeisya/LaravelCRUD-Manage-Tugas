...
<main class="main container" id="main"> 
        <div class="container mt-1">
            <div class="d-flex justify-content-end">
                <form class="d-flex me-3 mb-0" action="{{ route('tugas_umum.tugas') }}" method="GET">
                    <input type="text" name="cari" placeholder="Cari Nama Tugas ..." class="form-control me-2">
                    <button type="submit" class="btn btn-primary">Cari</button>
                </form> 
            <a href="{{ route('tugas_umum.tambah')}}" class="btn btn-success" >+ Tambah pengguna</a>
        </div>
            ...
            <tbody>
                ...
                {{-- Nomor urut = (2 - 1) x 10 + (5 + 1) = 1 x 10 + 6 = 16 --}}
                    ...
                    <td class="d-flex justify-content-center">
                        <a href="{{ route('tugas_umum.ubah',$bagian['id'])}}" class="btn btn-primary me-2">Edit</a>
...
<script>
    function showModalDelete(id, name) {
        ...
        let url = "{{ route('tugas_umum.hapus', ':id')}}";
